...
func TerminalPage(id, wsBase, ticket string, embed bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, " — terminal</title><link rel=\"icon\" href=\"/assets/favicon.svg\" type=\"image/svg+xml\"><link rel=\"stylesheet\" href=\"/assets/vendor/xterm.css\"><script src=\"/assets/vendor/xterm.js\"></script><script src=\"/assets/vendor/addon-fit.js\"></script><style>\n\t\t\t\thtml,\n\t\t\t\tbody {\n\t\t\t\t\tmargin: 0;\n\t\t\t\t\theight: 100%;\n\t\t\t\t\tbackground: #000;\n\t\t\t\t}\n\t\t\t\t#term {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\tinset: 0;\n\t\t\t\t\tpadding: 6px;\n\t\t\t\t\tbox-sizing: border-box;\n\t\t\t\t}\n\t\t\t\t#bar {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\ttop: 0;\n\t\t\t\t\tright: 0;\n\t\t\t\t\tleft: 0;\n\t\t\t\t\tz-index: 10;\n\t\t\t\t\tdisplay: flex;\n\t\t\t\t\talign-items: center;\n\t\t\t\t\tgap: 10px;\n\t\t\t\t\tpadding: 4px 10px;\n\t\t\t\t\tfont: 12px ui-monospace, monospace;\n\t\t\t\t\tcolor: #999;\n\t\t\t\t\tbackground: rgba(0, 0, 0, 0.65);\n\t\t\t\t}\n\t\t\t\t#bar.hidden {\n\t\t\t\t\tdisplay: none;\n\t\t\t\t}\n\t\t\t\t#bar .grow {\n\t\t\t\t\tflex: 1;\n\t\t\t\t}\n\t\t\t\t#dot {\n\t\t\t\t\twidth: 8px;\n\t\t\t\t\theight: 8px;\n\t\t\t\t\tborder-radius: 50%;\n\t\t\t\t\tbackground: #666;\n\t\t\t\t}\n\t\t\t\t#dot.ok {\n\t\t\t\t\tbackground: #34d399;\n\t\t\t\t}\n\t\t\t\t#dot.bad {\n\t\t\t\t\tbackground: #ef4444;\n\t\t\t\t}\n\t\t\t\t#dot.wait {\n\t\t\t\t\tbackground: #f59e0b;\n\t\t\t\t}\n\t\t\t\t#bar button {\n\t\t\t\t\tfont: 12px ui-monospace, monospace;\n\t\t\t\t\tpadding: 2px 8px;\n\t\t\t\t\tcolor: #ddd;\n\t\t\t\t\tbackground: #1a1a1a;\n\t\t\t\t\tborder: 1px solid #3a3a3a;\n\t\t\t\t\tborder-radius: 5px;\n\t\t\t\t\tcursor: pointer;\n\t\t\t\t}\n\t\t\t\t#bar button:hover {\n\t\t\t\t\tbackground: #262626;\n\t\t\t\t}\n\t\t\t\t#overlay {\n\t\t\t\t\tposition: fixed;\n\t\t\t\t\tinset: 0;\n\t\t\t\t\tdisplay: none;\n\t\t\t\t\talign-items: center;\n\t\t\t\t\tjustify-content: center;\n\t\t\t\t\tbackground: rgba(0, 0, 0, 0.72);\n\t\t\t\t\tz-index: 20;\n\t\t\t\t}\n\t\t\t\t#overlay .box {\n\t\t\t\t\tfont-family: ui-monospace, monospace;\n\t\t\t\t\tcolor: #ddd;\n\t\t\t\t\ttext-align: center;\n\t\t\t\t\tpadding: 24px 28px;\n\t\t\t\t\tborder: 1px solid #333;\n\t\t\t\t\tborder-radius: 8px;\n\t\t\t\t\tbackground: #0a0a0a;\n\t\t\t\t}\n\t\t\t\t#overlay button {\n\t\t\t\t\tfont: 13px ui-monospace, monospace;\n\t\t\t\t\tmargin: 12px 6px 0;\n\t\t\t\t\tpadding: 6px 14px;\n\t\t\t\t\tcolor: #eee;\n\t\t\t\t\tbackground: #1a1a1a;\n\t\t\t\t\tborder: 1px solid #444;\n\t\t\t\t\tborder-radius: 6px;\n\t\t\t\t\tcursor: pointer;\n\t\t\t\t}\n\t\t\t\t#overlay button:hover {\n\t\t\t\t\tbackground: #262626;\n\t\t\t\t}\n\t\t\t</style></head><body>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func TerminalNotFound(id string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "</b> was not found.</p><p><a href=\"/sandboxes\">← Back to dashboard</a></p></div></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
