...
// templui component button - version: v1.11.1 installed by templui v1.11.1
...
func Button(props ...Props) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if p.Href != "" && !p.Disabled {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/dashboard/components/button/button.templ`, Line: 1, Col: 0}
			}
